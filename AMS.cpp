...
void main_menu()
{
	cout<<"\n\n\n\n\t\t\t\tK R I S H N A K U N J     A P A R T M E N T"; Sleep(500);
...
void content(void)
{
	...
	char content2[100]="2. Expenses hapening in society (MONTHLY)";
	...
	cout<<"\n\n\t\t";
	for(int con3=0; con3<strlen(content1) ;con3++)
	{
		cout<<""<<content3[con3];
		Sleep(20);
	}
...
void option1(void)
{
	...
	char detail13[150]="IS CLUB HOUS AVAILABLE ? ------------->  YES";
...
int main()
{
	...
	switch(n)
	{
		...
		case 2:
			...
			cout<<"1. Watchman        : \t\t"<<w<<endl;
			cout<<"1. Floor cleaner   : \t\t"<<t<<endl;
			Sleep(1000);
	
			cout<<"\n\n****************Maintenance of our Apartment******************\n\n";
	
			cout<<"\nMaintenance for ONE BHK flats : \t"<<main.putmaintenance1()<<endl;
			cout<<"\nMaintenance for TWO BHK flats : \t"<<main.putmaintenance2()<<endl;
			cout<<"\nMaintenance for THREE BHK flats : \t"<<main.putmaintenance3()<<endl;
